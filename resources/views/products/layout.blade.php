...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/input-image.css') }}">
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="table.html"><i class="fas fa-table"></i><span>User</span></a><a class="nav-link" href="Merchant.html"><i class="fas fa-table"></i><span>Merchant</span></a></li>
